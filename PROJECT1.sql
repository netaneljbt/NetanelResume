...
פריווקט כולל 5 טבלאות המציגות קשר בין פעילות שמש לרעודות אדמה.
לצורך פרוייקט נלקחו 2 קבצי דאטה ממאגר 
KAGGLE.com

מאחר ולא קיים קשר ישר בין שני טבלאות, בוצע קישור נתונים ע"י יצירת שדה מיוחד לקישור טבלאות נוצרה  טבלה קישור חדשה :
DATE_EVENT

לאחר יצירת טבלאות , הזנת נתונים מבוצעם קודם לטבלאות ללא מפתחות זרים.
לאחר מילוי של כלל טבאות מבוצע עדכון שדות של קישור.


הוספתי מטה 3 שאולתות לדוגמא לבדיקת תקינות 
*/
